...
class MyData(Dataset):
    def __init__(self, train='train'):
        ...
        if self.istrain in ['train', 'val']:
            content_input = open('burst_raw/competition_train_input.0.2.bin', 'rb').read()
            content_gt = open('burst_raw/competition_train_gt.0.2.bin', 'rb').read()
            ...
            content_input = open('burst_raw/competition_test_input.0.2.bin', 'rb').read()
